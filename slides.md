...
![Screen shot of the access charges for the article linked on the previous slide ($49 for a PDF)](./images/access_charges.png)<!-- .element: width="500px" -->
![Screen shot of a Nature article from 1992 entitled "The growing inaccessibility of science". $8.99 to rent or buy, or $199.00 to subscribe.](./images/more_access_charges.png) <!-- .element width="500px" -->
